...
const Bio = ({navigation}) => {
    ...
    <Card.Divider/>
    <Text style={{fontSize:20,left:60,top:20}}>jdarkwah1@st.knust.edu.gh</Text>
    <Icon name="mail"  size={24} style={{right:150,bottom:2}}/>
    <Text style={{left:60,top:5}}>School Email Address</Text>
    <Text></Text>
    <Text style={{fontSize:20,left:60,top:5}}>jnrdrkw1@gmail.com</Text>
    ...
    <Card.Divider/>
    <Text style={{fontSize:20,left:50,top:30}}>JACHIE PRAMSO SENIOR HIGH SCHOOL</Text>
    <Icon name="location-pin"  size={24} style={{right:160,bottom:2}}/>
    <Text style={{fontSize:20,left:50,top:5}}>P.O.BOX 18</Text>
    <Text style={{fontSize:20,left:50,top:5}}>KUMASI-ASHANTI GHANA</Text>
